...
- `npm run localization:drill` passes and writes a reviewed `naikaku.localization-drill.v1` summary with dispatch manifests, dispatch simulations, runner manifests, and runner invocation packages for every supported locale.
