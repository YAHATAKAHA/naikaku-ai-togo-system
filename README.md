...
- Coding Agent Dispatch Manifest workbench export and CLI drill that write ready prompt packages plus receipt templates while proving production-held sessions do not receive assignable prompt files.
