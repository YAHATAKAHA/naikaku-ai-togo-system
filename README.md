...
- Coding Agent Dispatch Manifest, Archive, and Archive Audit workbench/CLI path that writes ready prompt packages and receipt templates while proving production-held sessions do not receive assignable prompt files.
