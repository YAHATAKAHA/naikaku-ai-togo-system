...
npm run verification:manifest # aggregate localization, executor, dispatch, simulation, runner, invocation, intake, self-test, sandbox-runner, receipt, and release evidence
