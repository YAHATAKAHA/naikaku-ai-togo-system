...
- Release Rehearsal self-check that locally simulates a cabinet run, automation handoff, executor evidence, release bundle, notes, and secret redaction before handoff.
