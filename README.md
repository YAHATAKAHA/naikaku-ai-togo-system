...
- Coding Agent Dispatch Manifest and Drill that write ready prompt packages plus receipt templates while proving production-held sessions do not receive assignable prompt files.
