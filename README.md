...
npm run verification:manifest # aggregate localization, executor, dispatch, simulation, runner, self-test, sandbox-runner, receipt, and release evidence
