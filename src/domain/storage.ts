...
export function serializeCodingAgentBriefsExport(briefs: CodingAgentBriefs) {
  return serializeCodingAgentBriefs(briefs);
}
...
export function serializeCodingAgentDispatchManifestExport(manifest: CodingAgentDispatchManifest) {
  return serializeCodingAgentDispatchManifest(manifest);
}
...
export function serializeCodingAgentDispatchArchiveAuditExport(audit: CodingAgentDispatchArchiveAudit) {
  return serializeCodingAgentDispatchArchiveAudit(audit);
}
...
export function serializeCodingAgentRunnerManifestExport(report: CodingAgentRunnerManifest) {
  return serializeCodingAgentRunnerManifest(report);
}

export function serializeCodingAgentRunnerManifestMarkdownExport(report: CodingAgentRunnerManifest) {
  return serializeCodingAgentRunnerManifestMarkdown(report);
}

export function serializeCodingAgentRunnerInvocationExport(report: CodingAgentRunnerInvocationPackage) {
  return serializeCodingAgentRunnerInvocationPackage(report);
}
...
export function serializeCodingAgentRunnerSelfTestExport(report: CodingAgentRunnerSelfTest) {
  return serializeCodingAgentRunnerSelfTest(report);
}
