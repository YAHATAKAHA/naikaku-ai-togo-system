...
export interface EngineeringLaunchpadCopy {
  ...
  autoWorkAdapterFixtureLabel: string;
  autoWorkAdapterReadyHelp: string;
  autoWorkLiveTokenHelp: string;
  autoWorkRun: string;
  ...
  guidedCabinetApiKeyAliasHelp: string;
  guidedCabinetEndpointLabel: string;
  guidedCabinetEndpointPlaceholder: string;
  safeStartLabel: string;
  safeStartSteps: Array<{ title: string; body: string }>;
