...
describe("i18n", () => {
  ...
  it("keeps core operator copy available for every locale", () => {
    for (const locale of expectedLocales) {
      ...
      expect(copy.cabinetCallingGateway("http://127.0.0.1:8787")).toBeTruthy();
      expect(copy.cabinetRunCompleted("live", 2, 1, 0)).toBeTruthy();
      expect(copy.cabinetRunFallback("offline")).toBeTruthy();
      expect(copy.providerReadiness.title).toBeTruthy();
      expect(copy.providerReadiness.quickSetupTitle).toBeTruthy();
      expect(copy.providerReadiness.quickSetupBody).toBeTruthy();
      expect(copy.providerReadiness.quickSetupApply(8)).toBeTruthy();
      expect(copy.providerReadiness.secretBoundary).toBeTruthy();
      expect(copy.providerReadiness.status("unchecked")).toBeTruthy();
      expect(copy.providerReadiness.source("local-fallback")).toBeTruthy();
      expect(
        copy.providerReadiness.message("unchecked", "static", "detail"),
      ).toBeTruthy();
      expect(copy.quickStart.title).toBeTruthy();
      expect(copy.quickStart.missionLabel).toBeTruthy();
      expect(copy.quickStart.runDry).toBeTruthy();
      expect(copy.quickStart.cabinetRoles(8)).toBeTruthy();
      expect(copy.quickStart.resultDecision("revise")).toBeTruthy();
      expect(copy.quickStart.resultSummary(8)).toBeTruthy();
      expect(copy.advancedWorkspace.returnToStart).toBeTruthy();
      expect(copy.advancedWorkspace.providers).toBeTruthy();
      expect(copy.advancedWorkspace.automation).toBeTruthy();
      expect(copy.engineeringLaunchpad.title).toBeTruthy();
      expect(copy.engineeringLaunchpad.state("ready-to-run")).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.permissionMode("mac-assisted"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.launchStage("sandbox-ready"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.nextAction("request-approval"),
      ).toBeTruthy();
      ...
      expect(
        copy.engineeringLaunchpad.realityCodeStatus(false, false, true, false),
      ).toBeTruthy();
      expect(copy.engineeringLaunchpad.realityMacStatus(false)).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.realityExternalStatus(true),
      ).toBeTruthy();
      expect(copy.engineeringLaunchpad.macScopeLabel).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macScopeItems.length,
      ...
      expect(
        copy.engineeringLaunchpad.macRunnerHonestyClaim(false),
      ).toBeTruthy();
      ...
      expect(
        copy.engineeringLaunchpad.macRunnerContractChecksLabel,
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerContractDeniedLabel,
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerContractInstructionsLabel,
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerSummary(2, 3, 1, 1, 2),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerContractSummary(10, 1, 8, 1, 40, 6),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerDecision("runtime-needed"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerCapability("keyboard-mouse"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerCapabilityStatus("needs-runtime"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerPermission("mac-accessibility"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerPermissionStatus("ask-before-use"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerAdapter("hammerspoon-adapter"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerAdapterStatus("needs-runtime"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerNextAction("connect-mac-adapter"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerContractDecision("runtime-needed"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerContractAction("observe-screen"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerContractActionStatus(
          "needs-runtime",
        ),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerContractCheckStatus("warn"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerContractDeniedAction("host-secrets"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.macRunnerContractInstruction(
          "require-approval",
        ),
      ).toBeTruthy();
      expect(copy.engineeringLaunchpad.missionDraftLabel).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.missionDraftScore(57, 4, 2, 1),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.missionDraftItem("approval-boundary"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.missionDraftStatus("missing"),
      ).toBeTruthy();
      ...
      expect(
        copy.engineeringLaunchpad.autoWorkAdapterFixtureLabel,
      ).toBeTruthy();
      ...
      expect(
        copy.engineeringLaunchpad.guidedCabinetModelPlaceholder,
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.guidedCabinetApiKeyAliasLabel,
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.guidedCabinetApiKeyAliasHelp,
      ).toBeTruthy();
      expect(copy.engineeringLaunchpad.guidedCabinetEndpointLabel).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.guidedCabinetEndpointPlaceholder,
      ).toBeTruthy();
      ...
      expect(copy.engineeringLaunchpad.guidedCycleStarting(1, 3)).toBeTruthy();
      expect(copy.engineeringLaunchpad.guidedCycleExecuting(1, 3)).toBeTruthy();
      expect(
      ...
      expect(
        copy.engineeringLaunchpad.guidedCycleBlocked(1, 3, "block"),
      ).toBeTruthy();
      expect(copy.engineeringLaunchpad.guidedCycleFailed(1, 3)).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.guidedCycleGatewayFailed("offline"),
      ).toBeTruthy();
      expect(copy.engineeringLaunchpad.guidedCycleSummary(1, 3)).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.autoWorkAdapterNeedsReady("openclaw-local"),
      ).toBeTruthy();
      expect(copy.engineeringLaunchpad.codexSmokeIdle).toBeTruthy();
      expect(copy.engineeringLaunchpad.codexSmokeStarting).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.codexSmokeCompleted(8, "output/codex"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.codexSmokeFailed(1, "output/codex"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.codexSmokeUnavailable("offline"),
      ).toBeTruthy();
      expect(copy.engineeringLaunchpad.codexSmokeResult(1, 1, 0)).toBeTruthy();
      ...
      expect(
        copy.engineeringLaunchpad.runnerPresetEnableStarting(
          "OpenClaw local agent",
        ),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.runnerPresetEnableCompleted(
          "OpenClaw local agent",
        ),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.runnerPresetEnableFailed("error"),
      ).toBeTruthy();
      ...
      expect(
        copy.engineeringLaunchpad.selfSimulationNextActionsLabel,
      ).toBeTruthy();
      expect(copy.engineeringLaunchpad.selfSimulationHonestyLabel).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.selfSimulationDecision("approval-required"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.selfSimulationStage("preflight"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.selfSimulationStageStatus("waiting"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.selfSimulationCapability("mac-desktop"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.selfSimulationCapabilityStatus(
          "approval-required",
        ),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.selfSimulationSummary(2, 1, 2, 8),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.selfSimulationStatus(
          "simulated-ready",
          2,
          2,
          8,
      ...
      expect(
        copy.engineeringLaunchpad.permissionRequestDeniedLabel,
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.permissionRequestSummary(6, 2, 5),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.permissionRequestDecision(
          "approval-required",
        ),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.permissionRequestMode("ask-before-use"),
      ).toBeTruthy();
      ...
      expect(
        copy.engineeringLaunchpad.capabilityGapSummary(50, 25, true, false),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.capabilityGapDecision("runtime-needed"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.capabilityGapItem("mac-desktop-control"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.capabilityGapStatus("missing"),
      ).toBeTruthy();
      ...
      expect(
        copy.engineeringLaunchpad.launchQueueSummary(2, 1, 0, 4, 8),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.launchQueueDecision("preflight-ready"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.launchQueueStatus("ready-to-run"),
      ).toBeTruthy();
      ...
      expect(
        copy.engineeringLaunchpad.executionReceiptClaimsLabel,
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.executionReceiptHonestyLabel,
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.executionReceiptSummary(2, 2, 2, 2, false),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.executionReceiptDecision("needs-evidence"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.executionReceiptStatus("needs-artifacts"),
      ).toBeTruthy();
      ...
      expect(
        copy.engineeringLaunchpad.handoffReceiptSummary(true, false, 2, 8),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.handoffReceiptDecision("agent-pack-ready"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.handoffLane("coding-agent"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.handoffLaneStatus("approval-required"),
      ).toBeTruthy();
      expect(copy.engineeringLaunchpad.completionGateLabel).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.completionGateNextActionLabel,
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.completionGateBlockedClaimsLabel,
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.completionGateSummary(false, false, false),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.completionGateDecision("simulation-only"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.completionGateDecision("evidence-ready"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.completionGateCheck("changed-files"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.completionGateCheckStatus("block"),
      ).toBeTruthy();
      ...
      expect(
        copy.engineeringLaunchpad.runnerReadinessStatus(1, 2, 1, 9),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.runnerReadinessUnavailable("offline"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.runnerReadinessAdapterStatus(
          "detected-needs-adapter",
        ),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.runnerReadinessDetected(2, 1),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.runnerReadinessNextActionLabel,
      ).toBeTruthy();
      expect(copy.engineeringLaunchpad.downloadSelfSimulationJson).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.downloadSelfSimulationMarkdown,
      ).toBeTruthy();
      expect(copy.engineeringLaunchpad.downloadLaunchQueueJson).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.downloadLaunchQueueMarkdown,
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.downloadExecutionReceiptJson,
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.downloadExecutionReceiptMarkdown,
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.capability("mac-accessibility"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.capabilityStatus("approval-required"),
      ).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.signal("mac-control-requested"),
      ).toBeTruthy();
      expect(copy.engineeringLaunchpad.unlockChecklistLabel).toBeTruthy();
      expect(
        copy.engineeringLaunchpad.unlockItem("review-held-sessions", 12),
      ).toBeTruthy();
      expect(copy.engineeringLaunchpad.unlockStatus("approval")).toBeTruthy();
      expect(copy.engineeringLaunchpad.steps).toHaveLength(5);
      expect(
        copy.engineeringLaunchpad.permissionGroups.length,
      ).toBeGreaterThanOrEqual(3);
      ...
      expect(
        copy.codingBriefs.downloadSandboxRunnerPreflightMarkdown,
      ).toBeTruthy();
      ...
      expect(
        copy.codingBriefs.dispatchDecisionLabel("dispatchable"),
      ).toBeTruthy();
      expect(
        copy.codingBriefs.dispatchAuditDecisionLabel("verified"),
      ).toBeTruthy();
      expect(
        copy.codingBriefs.dispatchSimulationDecisionLabel(
      ...
      expect(
        copy.codingBriefs.sandboxRunnerDecisionLabel("sandbox-runner-verified"),
      ).toBeTruthy();
      if (locale !== "en") {
        expect(
          copy.codingBriefs.dispatchDecisionLabel("dispatchable"),
        ).not.toBe("dispatchable");
      }
      ...
      expect(
        copy.codingBriefs.sandboxRunnerPreflightSummary(8, 0, 0, 2),
      ).toBeTruthy();
      expect(
      ...
      expect(
        copy.codingBriefs.statusSandboxRunnerPreflightBlocked(
          "blocked",
          0,
          8,
          1,
      ...
      expect(
        copy.codingBriefs.statusSandboxRunnerGateway(
      ...
      expect(
        copy.codingBriefs.statusSandboxRunnerUnavailable("offline"),
      ).toBeTruthy();
