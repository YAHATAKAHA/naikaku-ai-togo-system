...
const steps: CommandStep[] = [
  ...
  {
    label: "Dry-run release verification with localization, executor, sandbox capability, security red-team, runner auth, coding-agent dispatch/simulation/runner/invocation/intake/self-test/sandbox-runner/receipt drills and manifest",
    command: npmCommand,
