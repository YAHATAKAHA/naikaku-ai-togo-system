...
const steps: CommandStep[] = [
  ...
  {
    label: "Dry-run release verification with localization, executor, coding-agent dispatch/simulation/runner/invocation/intake/self-test/sandbox-runner/receipt drills and manifest",
    command: npmCommand,
